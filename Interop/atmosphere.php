<?php
/**
 * Atmosphere - Application web météo et environnement
 * 
 * @author Julie DEFOLIE
 * @version 1.0
 * @link https://github.com/Kwilium54/atmosphere
 * 
...
function geolocateIP($ip)
{
    try {
        ...
        // Configuration avec timeout + PROXY!!!! sinon ca fonctionne pas depuis webetu
        $options = [
            'http' => [
                'proxy' => 'tcp://www-cache:3128',
                'request_fulluri' => true,
...
function geocodeAddress($address)
{
    try {
        ...
        // Nominatim requiert un User-Agent + proxy webetu
        $options = [
            'http' => [
                'proxy' => 'tcp://www-cache:3128',
                'request_fulluri' => true,
